...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form  method="POST" action="{{ URL::route('admin.types.update', ['type' => $type->id   ]) }}" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <a href="{{ URL::route('admin.types') }}"><button class="btn btn-primary" type="button">Cancelar</button></a>
